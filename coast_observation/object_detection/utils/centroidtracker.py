...
class CentroidTracker:
    ...
    def update(self, rects):
        ...
        # centroids
            ...
            objectCentroidsTemp = list(self.objects.values())
            objectCentroids = []

            for each in objectCentroidsTemp:
                objectCentroids.append(each[0])
    ...
    def near_disappeared(self):
        result_list = []
        for objectID in list(self.disappeared.keys()):
            if self.disappeared[objectID] == self.maxDisappeared:
                result_list.append(objectID)
        return result_list
